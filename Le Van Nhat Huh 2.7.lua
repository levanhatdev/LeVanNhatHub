...
game.StarterGui:SetCore("SendNotification", {
	Title = "Thông Bao!", 
	Text = "Có thể bật các chức năng có biểu tượng này.\ncó thể sẵn sàng",
	Icon = "http://www.roblox.com/asset/?id=9610159123",
	Duration = 8
})

local win = library:Window("Switch",[[Hub]],[[Phiên Bản: 2.7 ]],"9606070311",Enum.KeyCode.RightControl)
...
General_Tab:Label("Treo/Cày Level")
...
General_Tab:Dropdown("Đánh Nhanh","Fast",MIo,function(vu)

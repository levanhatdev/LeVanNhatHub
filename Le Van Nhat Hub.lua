...
if game:GetService("CoreGui"):FindFirstChild("Le Van Nhat") then
	game:GetService("CoreGui"):FindFirstChild("Le Van Nhat"):Destroy()
end
local DiscordLib = {}
...
local win = DiscordLib:Window("Blox Fruits - V1.4 | Mobile/Pc | New Update :)", _G.Color, _G.Toggle)

local serv = win:Server("LeNhat XP X Phong Hub","")

local AutoFarm = serv:Channel("Trang Chủ", "http://www.roblox.com/asset/?id=7040391851")

Time = AutoFarm:Label("Giờ Tham Gia Sever")
...
local Stats = serv:Channel("Thống Kê","http://www.roblox.com/asset/?id=7040410130")

Stats:Toggle("Cận Chiến", _G.Melee, function(vu)
    Mad = vu
end)

Stats:Toggle("Phòng Thủ", _G.Defense, function(vu)
    Gan = vu
end)
...
Stats:Toggle("Trái Blox", _G.DevilFruit, function(vu)
    DevilFruit = vu
end)
...
spawn(function()
	while game:GetService("RunService").Heartbeat:wait() do
		...
		StatMelee:Refresh("Cận Chiến : "..tostring(game:GetService("Players").LocalPlayer.Data.Stats.Melee.Level.Value))
		StatDefense:Refresh("Phòng Thủ : "..tostring(game:GetService("Players").LocalPlayer.Data.Stats.Defense.Level.Value))
		StatSword:Refresh("Kiếm : "..tostring(game:GetService("Players").LocalPlayer.Data.Stats.Sword.Level.Value))
		StatGun:Refresh("Súng : "..tostring(game:GetService("Players").LocalPlayer.Data.Stats.Gun.Level.Value))
		StatFruit:Refresh("Trái Blox : "..tostring(game:GetService("Players").LocalPlayer.Data.Stats["Demon Fruit"].Level.Value))
	end
end)
...
Setting:Button("Ẩn Script Menu", function()
	if game:GetService("CoreGui"):FindFirstChild("Le Van Nhat") then
		game:GetService("CoreGui"):FindFirstChild("Le Van Nhat"):Destroy()
	end
end)

Setting:Button("Sao Chép Link Discord : Le Van Nhat", function()
...
DiscordLib:Notification("Thông Báo!", "Đã Update V1.4 Fix Hết Lỗi, Bug, Lag, Thêm Vài Chức Năng Mới.", "Đóng")

DiscordLib:Notification("Thông Báo!", "Cảm Ơn Bạn Đã Dùng Script Của Nhất :) Nhấp Okay Để Đọc Mô Tả Update.", "Okay")
game.StarterGui:SetCore("SendNotification", {
	Title = "Thông Báo!", 
	Text = "By Le Van Nhat XP\nGirlfriend: Min Ngo:3",

...
local serv = win:Server("Le Nhat XP X Phong Hub","")
...
DiscordLib:Notification("Cảnh Báo!", "Đã Update V1.4 Fix Hết Lỗi, Bug, Lag, Thêm Vài Chức Năng Mới.", "Okay")

DiscordLib:Notification("Thông Báo!", "Hợp Tác Pr: Chiến Thần Roblox X Phong Roblox. Tuyển Thành Viên Về Hỗ Trợ Lê Nhất Code :)", "Okay")
